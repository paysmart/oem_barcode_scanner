...
//  oem_barcode_scanner
//
//  Created by Higor Segobia on 02/03/21.
//
...
class QRCodeScannerViewController: UIViewController {
    ...
    var color : String!
    var text : String!
    var delegate: ScannerQRCodeDelegate? = nil
    let viewQRCode = UIView()
    let mainView = UIView()
    ...
    override func viewDidLoad() {
        ...
        DispatchQueue.main.async() { [self] in
            ...
            self.avPreviewLayer.connection?.videoOrientation = AVCaptureVideoOrientation.portrait
    ...
    private func setConstraintsForControls() {
        ...
        bottomView.heightAnchor.constraint(equalToConstant: 110.0).isActive=true

        topView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant:0).isActive = true
        topView.topAnchor.constraint(equalTo: view.topAnchor, constant:0).isActive = true
        topView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant:0).isActive = true
        topView.heightAnchor.constraint(equalToConstant: 110.0).isActive=true
        ...
        labelText.topAnchor.constraint(equalTo:view.topAnchor,constant: 20).isActive=true
...
extension QRCodeScannerViewController : AVCaptureMetadataOutputObjectsDelegate {
    func metadataOutput(_ output: AVCaptureMetadataOutput, didOutput metadataObjects: [AVMetadataObject], from connection: AVCaptureConnection)
    {
        ...
        if let metadataObject = metadataObjects.first {
            ...
            delegate?.userDidScanWith(qrCode: stringValue)
        }
